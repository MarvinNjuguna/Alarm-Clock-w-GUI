...
def createWidgets():
  label1 = Label(root, text = "Enter time (hh:mm) ")
  ...
  label2 = Label(root, text = "Enter message to dispay")
...
def submit():
  ...
  print(f"The Alarm time: {Alarmtime}")
  while Alarmtime != currenttime:
    currenttime = time.strftime("%H:%M")
    time.sleep(1)
  if Alarmtime == currenttime:
    print("Wake up!")
    label3.config(text="Alarm is righing")
